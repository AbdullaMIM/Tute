   ...
   <a href="#" class=" uplink" >language</a>
        ...
        <ul>
          ...
          <li><a href="#about">Admin Panel </a></li>
           ...
           <div class="bcWorks">
                <br>
               <p Style="font-size:30px">You have Successfully Registered!!!</p><br>
               <a href="Login.jsp"><button class="btn1" id="bttn1" name="bttn1" value="Sign Up" style="width:300px; height:28px; margin-left:220px">Click here to Login now</button></a>
